 ...
 <aside class ="aside-left">
				...
				<div class = "danhmuc">
					...
					<div class = "list-choice">
							<ul>
								<?php
		$sql_danhmuc="SELECT * FROM tbl_danhmuc,tbl_nhomsp WHERE tbl_danhmuc.id_nhomsp = tbl_nhomsp.id_nhomsp GROUP BY tbl_danhmuc.id_danhmuc HAVING tbl_nhomsp.id_nhomsp=3";
