 <?php
 $sql_product="SELECT * FROM tbl_sanpham,tbl_danhmuc,tbl_nhomsp WHERE tbl_danhmuc.id_nhomsp = tbl_nhomsp.id_nhomsp AND tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc GROUP BY tbl_sanpham.id_sanpham HAVING tbl_nhomsp.id_nhomsp=3 ORDER BY tbl_sanpham.id_sanpham DESC LIMIT 25";
