...
<table border="1" width="50%" style="border-collapse: collapse; ">
 ...
 <form method="POST" action="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham']?>" enctype="multipart/form-data">
  <tr>
   ...
   <tr>
    <td>Mã sp</td>
      <td><input type="text" value="<?php echo $row['masp']?>"  name="masp" width="100%"></td>
  </tr>
   <tr>
    <td>Giá sp</td>
...
<img src="modules/quanlysp/uploads/<?php echo $row['hinhanh'] ?>" width="150px">
   ...
   <tr>
    <td>Tóm tắt</td>
      <td><textarea rows="10" cols="50" name="tomtat" style="resize: none;"><?php  echo $row['tomtat']?></textarea></td>
  </tr>
   <tr>
    <td>Nội dung</td>
      <td><textarea rows="10" cols="50" name="noidung"style="resize: none;" ><?php echo $row['noidung']?></textarea> </td>
  </tr>
   <tr>
