 <?php
$sql_product="SELECT * FROM tbl_sanpham,tbl_danhmuc,tbl_nhomsp WHERE tbl_danhmuc.id_nhomsp = tbl_nhomsp.id_nhomsp AND tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc GROUP BY tbl_sanpham.id_sanpham HAVING tbl_nhomsp.id_nhomsp=2 ORDER BY tbl_sanpham.id_sanpham DESC LIMIT 25";
...
<!-- <div class="main"> -->
		<div class="main2">
				<div class="duong-dan">
					...
					<a href="laptop.php">Laptop, máy tính xách tay</a>
				</div>
